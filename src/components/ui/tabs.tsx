...
function TabsList({
  ...
  variant,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.List> & { variant?: "accent" }) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        ...
        variant === "accent" &&
          "[&>*[data-slot='tabs-trigger'][data-state='active']]:bg-primary/20 [&>*[data-slot='tabs-trigger'][data-state='active']]:text-primary",
        className
      )}
      {...props}
    />
